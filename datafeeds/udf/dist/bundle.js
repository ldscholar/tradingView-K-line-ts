...
var DataPulseProvider = /** @class */ (function () {
    function DataPulseProvider(historyProvider, updateFrequency) {
        ...
        setInterval(this._updateData.bind(this), 10000000);
    }
...
var UDFCompatibleDatafeedBase = /** @class */ (function () {
    function UDFCompatibleDatafeedBase(datafeedURL, quotesProvider, requester, updateFrequency) {
        ...
        this._quotesProvider = quotesProvider;
        this._dataPulseProvider = new DataPulseProvider(this._historyProvider, updateFrequency);//与初次拿数据无关
        this._quotesPulseProvider = new QuotesPulseProvider(this._quotesProvider);//与初次拿数据无关
        this._configurationReadyPromise = this._requestConfiguration()//与初次拿数据有关
